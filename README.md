...
* (Optionnal) `<COMMENT number> </COMMENT number>`: Surround a comment from the comment section of the video. If the query for the comments threads returns an error (such as when comments are disabled), this section is skipped.
